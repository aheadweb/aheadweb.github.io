...
},{}],"../node_modules/follow-redirects/node_modules/debug/src/common.js":[function(require,module,exports) {
"use strict";
...
},{"ms":"../node_modules/follow-redirects/node_modules/ms/index.js"}],"../node_modules/follow-redirects/node_modules/debug/src/browser.js":[function(require,module,exports) {
...
},{"./common":"../node_modules/follow-redirects/node_modules/debug/src/common.js","process":"../node_modules/process/browser.js"}],"../node_modules/follow-redirects/index.js":[function(require,module,exports) {
...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"lib/sber.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.new_order = exports.sberRegistration = void 0;

var _axios = _interopRequireDefault(require("axios"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var sberRegistration = function sberRegistration(params, add_info) {
  return _axios.default.post("".concat(undefined || window.API_ROOT || 'http://fapi.my', "/sber/registration"), params).then(function (response) {
    // console.log(JSON.stringify(response));
    if (response.data.form_url) {
      new_order({
        order: {
          sber_id: response.data.order_id,
          url: response.data.form_url,
          govno_id: add_info.govno_id,
          amount: params.amount,
          name: add_info.name,
          email: add_info.email,
          phone: add_info.phone,
          datetime: add_info.datetime,
          tickets_count: add_info.tickets_count,
          park_name: add_info.park_name
        }
      });
    } else {
...
}; // Сохранение пары номер заказа сбира и номер заказа говна на бэкэнде


exports.sberRegistration = sberRegistration;

var new_order = function new_order(params) {
  return _axios.default.post("".concat(undefined || window.API_ROOT || 'http://fapi.my', "/sber/orders"), params).then(function (response) {
    if (response.data.state === 'ok') {
      window.location.replace(params.order.url);
    } else {
      console.log(JSON.stringify(response));
    }
  }).catch(function (error) {
    console.log("\u043D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0441\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C \u0437\u0430\u043A\u0430\u0437 ".concat(error));
  });
};
...
//# sourceMappingURL=/sber.b14ca7e4.map